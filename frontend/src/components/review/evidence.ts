...
export const EVIDENCE: { label: string; value: string; note: string }[] = [
  ...
  { label: "Mutation testing", value: "47 / 47 red", note: "Re-run for the provider layer: security (14), Cloudflare/fallback/demo budget (15 backend, 3 frontend), live trace (15); earlier sets in COMPLETION_STATUS" },
